...
// 
namespace net.sf.wts.client.proxyFiles.Start {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="StartSoapBinding", Namespace="urn:Start")]
    public partial class StartService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback execOperationCompleted;
        
        /// <remarks/>
        public StartService() {
            this.Url = "http://localhost:8080/axis/services/Start";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:Start", ResponseNamespace="urn:Start")]
