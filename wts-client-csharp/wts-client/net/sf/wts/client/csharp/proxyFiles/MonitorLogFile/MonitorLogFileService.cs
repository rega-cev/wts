...
// 
namespace net.sf.wts.client.proxyFiles.MonitorLogFile {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MonitorLogFileSoapBinding", Namespace="urn:MonitorLogFile")]
    public partial class MonitorLogFileService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback execOperationCompleted;
        
        /// <remarks/>
        public MonitorLogFileService() {
            this.Url = "http://localhost:8080/axis/services/MonitorLogFile";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:MonitorLogFile", ResponseNamespace="urn:MonitorLogFile")]
        [return: System.Xml.Serialization.SoapElementAttribute("execReturn", DataType="base64Binary")]
        public byte[] exec(string in0, string in1) {
