...
// 
namespace net.sf.wts.client.proxyFiles.GetChallenge {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="GetChallengeSoapBinding", Namespace="urn:GetChallenge")]
    public partial class GetChallengeService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback execOperationCompleted;
        
        /// <remarks/>
        public GetChallengeService() {
            this.Url = "http://localhost:8080/axis/services/GetChallenge";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:GetChallenge", ResponseNamespace="urn:GetChallenge")]
        [return: System.Xml.Serialization.SoapElementAttribute("execReturn")]
        public string exec(string in0) {
