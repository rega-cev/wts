...
// 
namespace net.sf.wts.client.proxyFiles.GetServiceDescription {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="GetServiceDescriptionSoapBinding", Namespace="urn:GetServiceDescription")]
    public partial class GetServiceDescriptionService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback execOperationCompleted;
        
        /// <remarks/>
        public GetServiceDescriptionService() {
            this.Url = "http://localhost:8080/axis/services/GetServiceDescription";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:GetServiceDescription", ResponseNamespace="urn:GetServiceDescription")]
        [return: System.Xml.Serialization.SoapElementAttribute("execReturn", DataType="base64Binary")]
        public byte[] exec(string in0) {
        ...
        /// <remarks/>
        public System.IAsyncResult Beginexec(string in0, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public void execAsync(string in0) {
            this.execAsync(in0, null);
        }
        
        /// <remarks/>
        public void execAsync(string in0, object userState) {
            ...
            this.InvokeAsync("exec", new object[] {
                        in0}, this.execOperationCompleted, userState);
        }
