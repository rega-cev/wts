...
// 
namespace net.sf.wts.client.proxyFiles.MonitorLogTail {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MonitorLogTailSoapBinding", Namespace="urn:MonitorLogTail")]
    public partial class MonitorLogTailService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback execOperationCompleted;
        
        /// <remarks/>
        public MonitorLogTailService() {
            this.Url = "http://localhost:8080/axis/services/MonitorLogTail";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="urn:MonitorLogTail", ResponseNamespace="urn:MonitorLogTail")]
        [return: System.Xml.Serialization.SoapElementAttribute("execReturn", DataType="base64Binary")]
        public byte[] exec(string in0, string in1, int in2) {
        ...
        /// <remarks/>
        public System.IAsyncResult Beginexec(string in0, string in1, int in2, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public void execAsync(string in0, string in1, int in2) {
            this.execAsync(in0, in1, in2, null);
        }
        
        /// <remarks/>
        public void execAsync(string in0, string in1, int in2, object userState) {
